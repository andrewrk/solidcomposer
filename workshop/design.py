...
only_managers_can_edit_band_settings = "Only band managers can edit band settings."
only_band_members_can_create_projects = "Only band members can create new projects."
