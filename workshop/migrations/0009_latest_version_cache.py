...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for project in orm['workshop.Project'].objects.all():
            project.latest_version = orm['workshop.ProjectVersion'].objects.filter(project=project).order_by('-version')[0]
            project.title = project.latest_version.song.title
            project.save()
