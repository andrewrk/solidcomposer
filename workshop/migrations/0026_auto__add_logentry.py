...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('workshop_logentry', (
            ...
            ('catalyst', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='catalyst', null=True, to=orm['auth.User'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='target', null=True, to=orm['auth.User'])),
            ('node', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.SongCommentNode'], null=True, blank=True)),
            ('version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workshop.ProjectVersion'], null=True, blank=True)),
        ))
        db.send_create_signal('workshop', ['LogEntry'])


    def backwards(self, orm):
        
        # Deleting model 'LogEntry'
        db.delete_table('workshop_logentry')
