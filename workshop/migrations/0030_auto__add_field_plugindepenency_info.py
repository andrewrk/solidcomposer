...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PluginDepenency.info'
        db.add_column('workshop_plugindepenency', 'info', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PluginDepenency.info'
        db.delete_column('workshop_plugindepenency', 'info')
