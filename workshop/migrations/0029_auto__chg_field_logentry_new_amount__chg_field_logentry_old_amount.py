...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LogEntry.new_amount'
        db.alter_column('workshop_logentry', 'new_amount', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'LogEntry.old_amount'
        db.alter_column('workshop_logentry', 'old_amount', self.gf('django.db.models.fields.BigIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'LogEntry.new_amount'
        db.alter_column('workshop_logentry', 'new_amount', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'LogEntry.old_amount'
        db.alter_column('workshop_logentry', 'old_amount', self.gf('django.db.models.fields.IntegerField')())
