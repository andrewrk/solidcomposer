...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PluginDepenency.price'
        db.alter_column('workshop_plugindepenency', 'price', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Adding field 'Studio.external_url'
        db.add_column('workshop_studio', 'external_url', self.gf('django.db.models.fields.CharField')(max_length=500, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'Studio.price'
        db.add_column('workshop_studio', 'price', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'PluginDepenency.price'
        db.alter_column('workshop_plugindepenency', 'price', self.gf('django.db.models.fields.FloatField')())

        # Deleting field 'Studio.external_url'
        db.delete_column('workshop_studio', 'external_url')

        # Deleting field 'Studio.price'
        db.delete_column('workshop_studio', 'price')
