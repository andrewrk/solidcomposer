...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PluginDepenency.comes_with_studio'
        db.add_column('workshop_plugindepenency', 'comes_with_studio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workshop.Studio'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PluginDepenency.comes_with_studio'
        db.delete_column('workshop_plugindepenency', 'comes_with_studio_id')
