...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PluginDepenency.url'
        db.alter_column('workshop_plugindepenency', 'url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))


    def backwards(self, orm):
        
        # Changing field 'PluginDepenency.url'
        db.alter_column('workshop_plugindepenency', 'url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))
