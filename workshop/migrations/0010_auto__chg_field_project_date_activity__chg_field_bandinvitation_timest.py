...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.date_activity'
        db.alter_column('workshop_project', 'date_activity', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'BandInvitation.timestamp'
        db.alter_column('workshop_bandinvitation', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Project.date_activity'
        db.alter_column('workshop_project', 'date_activity', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))

        # Changing field 'BandInvitation.timestamp'
        db.alter_column('workshop_bandinvitation', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))
    ...
    models = {
        ...
        'main.band': {
            ...
            'samples': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'band_samples'", 'symmetrical': 'False', 'to': "orm['workshop.SampleDependency']"}),
