...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectVersion.old_title'
        db.add_column('workshop_projectversion', 'old_title', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProjectVersion.old_title'
        db.delete_column('workshop_projectversion', 'old_title')
