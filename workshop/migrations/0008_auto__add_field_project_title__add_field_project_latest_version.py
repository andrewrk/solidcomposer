...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('workshop_project', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Project.latest_version'
        db.add_column('workshop_project', 'latest_version', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='latest_version', null=True, to=orm['workshop.ProjectVersion']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.title'
        db.delete_column('workshop_project', 'title')

        # Deleting field 'Project.latest_version'
        db.delete_column('workshop_project', 'latest_version_id')
