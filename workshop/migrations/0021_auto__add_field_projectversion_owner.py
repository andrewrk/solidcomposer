...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectVersion.owner'
        db.add_column('workshop_projectversion', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProjectVersion.owner'
        db.delete_column('workshop_projectversion', 'owner_id')
