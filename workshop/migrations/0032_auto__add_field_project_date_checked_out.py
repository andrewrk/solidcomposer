...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.date_checked_out'
        db.add_column('workshop_project', 'date_checked_out', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.date_checked_out'
        db.delete_column('workshop_project', 'date_checked_out')
