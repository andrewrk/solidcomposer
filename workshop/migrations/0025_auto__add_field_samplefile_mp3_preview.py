...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SampleFile.mp3_preview'
        db.add_column('workshop_samplefile', 'mp3_preview', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SampleFile.mp3_preview'
        db.delete_column('workshop_samplefile', 'mp3_preview')
