...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LogEntry.old_amount'
        db.add_column('workshop_logentry', 'old_amount', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'LogEntry.new_amount'
        db.add_column('workshop_logentry', 'new_amount', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LogEntry.old_amount'
        db.delete_column('workshop_logentry', 'old_amount')

        # Deleting field 'LogEntry.new_amount'
        db.delete_column('workshop_logentry', 'new_amount')
    ...
    models = {
        ...
        'workshop.logentry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_amount': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'node': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.SongCommentNode']", 'null': 'True', 'blank': 'True'}),
            'old_amount': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
