...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LogEntry.project'
        db.add_column('workshop_logentry', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workshop.Project'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LogEntry.project'
        db.delete_column('workshop_logentry', 'project_id')
