...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProjectVersion.title'
        db.delete_column('workshop_projectversion', 'title')

        # Deleting field 'ProjectVersion.comments'
        db.delete_column('workshop_projectversion', 'comments')


    def backwards(self, orm):
        
        # Adding field 'ProjectVersion.title'
        db.add_column('workshop_projectversion', 'title', self.gf('django.db.models.fields.CharField')(default='none', max_length=100), keep_default=False)

        # Adding field 'ProjectVersion.comments'
        db.add_column('workshop_projectversion', 'comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
