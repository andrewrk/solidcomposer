...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PluginDepenency.url'
        db.add_column('workshop_plugindepenency', 'url', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True), keep_default=False)

        # Adding field 'PluginDepenency.external_url'
        db.add_column('workshop_plugindepenency', 'external_url', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True), keep_default=False)

        # Adding field 'PluginDepenency.price'
        db.add_column('workshop_plugindepenency', 'price', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PluginDepenency.url'
        db.delete_column('workshop_plugindepenency', 'url')

        # Deleting field 'PluginDepenency.external_url'
        db.delete_column('workshop_plugindepenency', 'external_url')

        # Deleting field 'PluginDepenency.price'
        db.delete_column('workshop_plugindepenency', 'price')
    ...
    models = {
        ...
        'workshop.plugindepenency': {
            ...
            'url': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True'})
        },
        'workshop.project': {
