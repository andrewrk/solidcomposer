...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProjectVersion.timestamp'
        db.delete_column('workshop_projectversion', 'timestamp')


    def backwards(self, orm):
        
        # Adding field 'ProjectVersion.timestamp'
        db.add_column('workshop_projectversion', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2010, 5, 31, 7, 26, 52, 888516), blank=True), keep_default=False)
