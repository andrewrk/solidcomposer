...
bad_band_member_id = "Bad band member id."
...
can_only_edit_your_own_amount_donated = "You may only edit your own amount donated."
invalid_amount = "Invalid amount."
you_dont_have_enough_space_to_do_that = "You do not have enough space to do that."
