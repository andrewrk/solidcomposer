...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for song in orm['main.Song'].objects.all():
            node = orm['main.SongCommentNode']()
            node.song = song
            node.date_created = song.date_added
            node.date_edited = song.date_added
            node.owner = song.owner
            node.content = song.comments
    ...
    def backwards(self, orm):
        for node in orm['main.SongCommentNode'].objects.all():
            node.song.comments = node.content
            node.song.save()
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 25, 0, 14, 24, 924672)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
