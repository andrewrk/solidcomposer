...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Band.date_created'
        db.alter_column('main_band', 'date_created', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Band.date_created'
        db.alter_column('main_band', 'date_created', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 23, 7, 30, 38, 278326)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
