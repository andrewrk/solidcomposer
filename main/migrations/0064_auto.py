...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field studios on 'Profile'
        db.create_table('main_profile_studios', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm['main.profile'], null=False)),
            ('studio', models.ForeignKey(orm['workshop.studio'], null=False))
        ))
        db.create_unique('main_profile_studios', ['profile_id', 'studio_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field studios on 'Profile'
        db.delete_table('main_profile_studios')
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 22, 2, 29, 29, 144303)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
