...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SongCommentNode.content'
        db.alter_column('main_songcommentnode', 'content', self.gf('django.db.models.fields.TextField')(max_length=9000, blank=True))


    def backwards(self, orm):
        
        # Changing field 'SongCommentNode.content'
        db.alter_column('main_songcommentnode', 'content', self.gf('django.db.models.fields.TextField')(max_length=2000, blank=True))
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 25, 23, 13, 4, 218061)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
