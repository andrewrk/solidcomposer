...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_song', 'album', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Song.album'
        db.alter_column('main_song', 'album', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 23, 1, 23, 4, 905202)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
