...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.total_space'
        db.delete_column('main_profile', 'total_space')

        # Deleting field 'Profile.used_space'
        db.delete_column('main_profile', 'used_space')

        # Adding field 'Profile.purchased_bytes'
        db.add_column('main_profile', 'purchased_bytes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Band.total_space'
        db.add_column('main_band', 'total_space', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Band.used_space'
        db.add_column('main_band', 'used_space', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Profile.total_space'
        db.add_column('main_profile', 'total_space', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Profile.used_space'
        db.add_column('main_profile', 'used_space', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Profile.purchased_bytes'
        db.delete_column('main_profile', 'purchased_bytes')

        # Deleting field 'Band.total_space'
        db.delete_column('main_band', 'total_space')

        # Deleting field 'Band.used_space'
        db.delete_column('main_band', 'used_space')
