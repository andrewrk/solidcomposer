...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.studio'
        db.alter_column('main_song', 'studio_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workshop.Studio'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Song.studio'
        db.alter_column('main_song', 'studio_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Studio'], null=True, blank=True))
