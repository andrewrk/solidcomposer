...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.date_activity'
        db.alter_column('main_profile', 'date_activity', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ThumbsUp.date_given'
        db.alter_column('main_thumbsup', 'date_given', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'SongComment.date_created'
        db.alter_column('main_songcomment', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'SongComment.date_edited'
        db.alter_column('main_songcomment', 'date_edited', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Entry.edit_date'
        db.alter_column('main_entry', 'edit_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Entry.submit_date'
        db.alter_column('main_entry', 'submit_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Competition.date_created'
        db.alter_column('main_competition', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Song.date_added'
        db.alter_column('main_song', 'date_added', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Profile.date_activity'
        db.alter_column('main_profile', 'date_activity', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))

        # Changing field 'ThumbsUp.date_given'
        db.alter_column('main_thumbsup', 'date_given', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))

        # Changing field 'SongComment.date_created'
        db.alter_column('main_songcomment', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Changing field 'SongComment.date_edited'
        db.alter_column('main_songcomment', 'date_edited', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))

        # Changing field 'Entry.edit_date'
        db.alter_column('main_entry', 'edit_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))

        # Changing field 'Entry.submit_date'
        db.alter_column('main_entry', 'submit_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Changing field 'Competition.date_created'
        db.alter_column('main_competition', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Changing field 'Song.date_added'
        db.alter_column('main_song', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))
