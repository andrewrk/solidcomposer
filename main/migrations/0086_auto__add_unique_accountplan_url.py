...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'AccountPlan', fields ['url']
        db.create_unique('main_accountplan', ['url'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AccountPlan', fields ['url']
        db.delete_unique('main_accountplan', ['url'])
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 17, 4, 30, 54, 215134)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
