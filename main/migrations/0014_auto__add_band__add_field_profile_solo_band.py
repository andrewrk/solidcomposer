...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Band'
        db.create_table('main_band', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('main', ['Band'])

        # Adding field 'Profile.solo_band'
        db.add_column('main_profile', 'solo_band', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Band'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'Band'
        db.delete_table('main_band')

        # Deleting field 'Profile.solo_band'
        db.delete_column('main_profile', 'solo_band_id')
    ...
    models = {
        ...
        'main.profile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'solo_band': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Band']", 'null': 'True'}),
