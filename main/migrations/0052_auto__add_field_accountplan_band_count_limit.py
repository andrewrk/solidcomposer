...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountPlan.band_count_limit'
        db.add_column('main_accountplan', 'band_count_limit', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccountPlan.band_count_limit'
        db.delete_column('main_accountplan', 'band_count_limit')
