...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BandMember.space_donated'
        db.alter_column('main_bandmember', 'space_donated', self.gf('django.db.models.fields.BigIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'BandMember.space_donated'
        db.alter_column('main_bandmember', 'space_donated', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 22, 9, 38, 40, 902424)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
