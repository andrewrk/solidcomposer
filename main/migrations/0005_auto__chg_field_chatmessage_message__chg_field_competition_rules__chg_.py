...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_chatmessage', 'message', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True))

        # Changing field 'Competition.rules'
        db.alter_column('main_competition', 'rules', self.gf('django.db.models.fields.TextField')(blank=True))

        # Changing field 'Competition.theme'
        db.alter_column('main_competition', 'theme', self.gf('django.db.models.fields.TextField')(blank=True))

        # Changing field 'Song.waveform_img'
        db.alter_column('main_song', 'waveform_img', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'ChatMessage.message'
        db.alter_column('main_chatmessage', 'message', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Changing field 'Competition.rules'
        db.alter_column('main_competition', 'rules', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'Competition.theme'
        db.alter_column('main_competition', 'theme', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'Song.waveform_img'
        db.alter_column('main_song', 'waveform_img', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True))
