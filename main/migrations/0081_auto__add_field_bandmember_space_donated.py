...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BandMember.space_donated'
        db.add_column('main_bandmember', 'space_donated', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BandMember.space_donated'
        db.delete_column('main_bandmember', 'space_donated')
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 15, 2, 7, 59, 675909)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
