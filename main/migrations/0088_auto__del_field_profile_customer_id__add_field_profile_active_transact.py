...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.customer_id'
        db.delete_column('main_profile', 'customer_id')

        # Adding field 'Profile.active_transaction'
        db.add_column('main_profile', 'active_transaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Transaction'], null=True, blank=True), keep_default=False)

        # Adding field 'Transaction.token_id'
        db.add_column('main_transaction', 'token_id', self.gf('django.db.models.fields.CharField')(max_length=65, null=True, blank=True), keep_default=False)

        # Adding field 'Transaction.expiry'
        db.add_column('main_transaction', 'expiry', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'Transaction.timestamp'
        db.add_column('main_transaction', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 8, 18, 8, 31, 19, 35442)), keep_default=False)

        # Adding field 'Transaction.plan'
        db.add_column('main_transaction', 'plan', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.AccountPlan']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Profile.customer_id'
        db.add_column('main_profile', 'customer_id', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Deleting field 'Profile.active_transaction'
        db.delete_column('main_profile', 'active_transaction_id')

        # Deleting field 'Transaction.token_id'
        db.delete_column('main_transaction', 'token_id')

        # Deleting field 'Transaction.expiry'
        db.delete_column('main_transaction', 'expiry')

        # Deleting field 'Transaction.timestamp'
        db.delete_column('main_transaction', 'timestamp')

        # Deleting field 'Transaction.plan'
        db.delete_column('main_transaction', 'plan_id')
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 18, 11, 30, 59, 445745)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
