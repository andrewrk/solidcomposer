...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_song', 'band', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Band'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Song.band'
        db.delete_column('main_song', 'band_id')
