...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field samples on 'Profile'
        db.delete_table('main_profile_samples')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field samples on 'Profile'
        db.create_table('main_profile_samples', (
        ...
        db.create_unique('main_profile_samples', ['profile_id', 'sampledependency_id'])
