...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Band.date_created'
        db.add_column('main_band', 'date_created', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Band.date_created'
        db.delete_column('main_band', 'date_created')
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 23, 5, 58, 19, 656117)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
