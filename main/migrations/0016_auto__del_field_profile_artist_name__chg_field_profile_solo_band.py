...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.artist_name'
        db.delete_column('main_profile', 'artist_name')

        # Changing field 'Profile.solo_band'
        db.alter_column('main_profile', 'solo_band_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Band']))
    
    
    def backwards(self, orm):
        
        # Adding field 'Profile.artist_name'
        db.add_column('main_profile', 'artist_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Changing field 'Profile.solo_band'
        db.alter_column('main_profile', 'solo_band_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Band'], null=True))
