...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SongCommentNode.parent'
        db.add_column('main_songcommentnode', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.SongCommentNode'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SongCommentNode.parent'
        db.delete_column('main_songcommentnode', 'parent_id')
    ...
    models = {
        ...
        'main.song': {
            ...
            'band': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Band']"}),
            'comment_node': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'song_comment_node'", 'to': "orm['main.SongCommentNode']"}),
        ...
        'main.songcommentnode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.SongCommentNode']", 'null': 'True'}),
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 25, 1, 32, 14, 781560)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
