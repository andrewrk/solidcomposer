...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.band'
        db.alter_column('main_song', 'band_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Band']))
    
    
    def backwards(self, orm):
        
        # Changing field 'Song.band'
        db.alter_column('main_song', 'band_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Band'], null=True))
