...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.is_open_source'
        db.add_column('main_song', 'is_open_source', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Song.is_open_source'
        db.delete_column('main_song', 'is_open_source')
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 23, 3, 41, 12, 634111)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
