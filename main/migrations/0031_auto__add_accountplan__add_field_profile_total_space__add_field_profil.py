...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AccountPlan'
        db.create_table('main_accountplan', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('usd_per_month', self.gf('django.db.models.fields.FloatField')()),
            ('total_space', self.gf('django.db.models.fields.IntegerField')()),
            ('customer_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('main', ['AccountPlan'])

        # Adding field 'Profile.total_space'
        db.add_column('main_profile', 'total_space', self.gf('django.db.models.fields.IntegerField')(default=536870912), keep_default=False)
        ...
        # Adding field 'Profile.plan'
        db.add_column('main_profile', 'plan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.AccountPlan'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'AccountPlan'
        db.delete_table('main_accountplan')
        ...
        # Deleting field 'Profile.plan'
        db.delete_column('main_profile', 'plan_id')
