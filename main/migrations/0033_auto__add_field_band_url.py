...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Band.url'
        db.add_column('main_band', 'url', self.gf('django.db.models.fields.CharField')(max_length=110, unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Band.url'
        db.delete_column('main_band', 'url')
