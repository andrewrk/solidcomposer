...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_thumbsup', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'SongComment.owner'
        db.alter_column('main_songcomment', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Entry.owner'
        db.alter_column('main_entry', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Competition.host'
        db.alter_column('main_competition', 'host_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Song.owner'
        db.alter_column('main_song', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
