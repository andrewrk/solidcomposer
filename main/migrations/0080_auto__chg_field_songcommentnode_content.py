...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SongCommentNode.content'
        db.alter_column('main_songcommentnode', 'content', self.gf('django.db.models.fields.TextField')(blank=True))
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 14, 3, 24, 29, 192094)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
