...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field samples on 'Band'
        db.create_table('main_band_samples', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('band', models.ForeignKey(orm['main.band'], null=False)),
            ('sampledependency', models.ForeignKey(orm['workshop.sampledependency'], null=False))
        ))
        db.create_unique('main_band_samples', ['band_id', 'sampledependency_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field samples on 'Band'
        db.delete_table('main_band_samples')
    ...
    models = {
        ...
        'main.profile': {
            ...
            'samples': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'profile_samples'", 'blank': 'True', 'to': "orm['workshop.SampleDependency']"}),
