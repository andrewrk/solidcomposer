...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SongCommentNode.deleted'
        db.add_column('main_songcommentnode', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'SongCommentNode.parent'
        db.alter_column('main_songcommentnode', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.SongCommentNode'], null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'SongCommentNode.deleted'
        db.delete_column('main_songcommentnode', 'deleted')

        # Changing field 'SongCommentNode.parent'
        db.alter_column('main_songcommentnode', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.SongCommentNode'], null=True))
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 2, 13, 44, 56, 76584)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
