...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.usd_per_month'
        db.add_column('main_profile', 'usd_per_month', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Profile.band_count_limit'
        db.add_column('main_profile', 'band_count_limit', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
        ...
        # Changing field 'Profile.plan'
        db.alter_column('main_profile', 'plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.AccountPlan'], null=True, blank=True))

        # Deleting field 'AccountPlan.customer_id'
        db.delete_column('main_accountplan', 'customer_id')

        # Adding field 'Band.abandon_date'
        db.add_column('main_band', 'abandon_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.usd_per_month'
        db.delete_column('main_profile', 'usd_per_month')

        # Deleting field 'Profile.band_count_limit'
        db.delete_column('main_profile', 'band_count_limit')

        # Deleting field 'Profile.customer_id'
        db.delete_column('main_profile', 'customer_id')

        # Changing field 'Profile.plan'
        db.alter_column('main_profile', 'plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.AccountPlan'], null=True))

        # Adding field 'AccountPlan.customer_id'
        db.add_column('main_accountplan', 'customer_id', self.gf('django.db.models.fields.IntegerField')(default=''), keep_default=False)

        # Deleting field 'Band.abandon_date'
        db.delete_column('main_band', 'abandon_date')
    ...
    models = {
        ...
        'main.profile': {
            ...
            'purchased_bytes': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
