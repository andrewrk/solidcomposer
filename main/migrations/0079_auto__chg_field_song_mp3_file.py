...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.mp3_file'
        db.alter_column('main_song', 'mp3_file', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Song.mp3_file'
        db.alter_column('main_song', 'mp3_file', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True))
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 13, 3, 5, 41, 80625)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
