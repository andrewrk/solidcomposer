...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_tempfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('path', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('death_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 6, 17, 20, 52, 58, 100016))),
        ))
        db.send_create_signal('main', ['TempFile'])


    def backwards(self, orm):
        
        # Deleting model 'TempFile'
        db.delete_table('main_tempfile')
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 17, 20, 52, 58, 100016)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
