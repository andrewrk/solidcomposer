...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.account_expire_date'
        db.add_column('main_profile', 'account_expire_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.account_expire_date'
        db.delete_column('main_profile', 'account_expire_date')
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 16, 1, 40, 20, 60910)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
