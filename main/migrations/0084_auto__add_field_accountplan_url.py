...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountPlan.url'
        db.add_column('main_accountplan', 'url', self.gf('django.db.models.fields.CharField')(default='hi', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccountPlan.url'
        db.delete_column('main_accountplan', 'url')
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 17, 4, 29, 5, 164827)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
