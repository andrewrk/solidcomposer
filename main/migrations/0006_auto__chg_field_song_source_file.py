...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.source_file'
        db.alter_column('main_song', 'source_file', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Song.source_file'
        db.alter_column('main_song', 'source_file', self.gf('django.db.models.fields.CharField')(max_length=500))
