...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_bandmember', (
        ...
        db.send_create_signal('main', ['BandMember'])

        # Adding field 'Profile.bio'
        db.add_column('main_profile', 'bio', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Profile.avatar'
        db.add_column('main_profile', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Band.openness'
        db.add_column('main_band', 'openness', self.gf('django.db.models.fields.IntegerField')(default=4), keep_default=False)

        # Adding field 'Band.concurrent_editing'
        db.add_column('main_band', 'concurrent_editing', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Band.bio'
        db.add_column('main_band', 'bio', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'BandMember'
        db.delete_table('main_bandmember')

        # Deleting field 'Profile.bio'
        db.delete_column('main_profile', 'bio')

        # Deleting field 'Profile.avatar'
        db.delete_column('main_profile', 'avatar')

        # Deleting field 'Band.openness'
        db.delete_column('main_band', 'openness')

        # Deleting field 'Band.concurrent_editing'
        db.delete_column('main_band', 'concurrent_editing')

        # Deleting field 'Band.bio'
        db.delete_column('main_band', 'bio')
