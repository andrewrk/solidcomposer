...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChatRoom.start_date'
        db.add_column('main_chatroom', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'ChatRoom.end_date'
        db.add_column('main_chatroom', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ChatRoom.start_date'
        db.delete_column('main_chatroom', 'start_date')

        # Deleting field 'ChatRoom.end_date'
        db.delete_column('main_chatroom', 'end_date')
