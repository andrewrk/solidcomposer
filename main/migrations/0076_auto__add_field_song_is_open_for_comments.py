...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.is_open_for_comments'
        db.add_column('main_song', 'is_open_for_comments', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Song.is_open_for_comments'
        db.delete_column('main_song', 'is_open_for_comments')
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 15, 20, 37, 3, 641241)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
