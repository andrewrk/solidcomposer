...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.artist_name'
        db.alter_column('main_profile', 'artist_name', self.gf('django.db.models.fields.CharField')(max_length=100))
    
    
    def backwards(self, orm):
        
        # Changing field 'Profile.artist_name'
        db.alter_column('main_profile', 'artist_name', self.gf('django.db.models.fields.CharField')(max_length=256))
