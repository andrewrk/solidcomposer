...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SongCommentNode.version'
        db.add_column('main_songcommentnode', 'version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workshop.ProjectVersion'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SongCommentNode.version'
        db.delete_column('main_songcommentnode', 'version_id')
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 26, 1, 48, 12, 956928)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
