...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SongCommentNode.song'
        db.alter_column('main_songcommentnode', 'song_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Song'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'SongCommentNode.song'
        db.alter_column('main_songcommentnode', 'song_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Song']))
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 8, 4, 44, 32, 63431)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
