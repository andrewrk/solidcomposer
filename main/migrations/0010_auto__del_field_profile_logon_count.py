...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.logon_count'
        db.delete_column('main_profile', 'logon_count')
    
    
    def backwards(self, orm):
        
        # Adding field 'Profile.logon_count'
        db.add_column('main_profile', 'logon_count', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
