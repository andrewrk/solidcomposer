...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.edit_date'
        db.add_column('main_entry', 'edit_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2010, 4, 29, 1, 26, 49, 556628), blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Entry.edit_date'
        db.delete_column('main_entry', 'edit_date')
