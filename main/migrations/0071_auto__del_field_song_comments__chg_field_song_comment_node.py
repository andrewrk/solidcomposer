...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.comment_node'
        db.alter_column('main_song', 'comment_node_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.SongCommentNode']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Song.comment_node'
        db.alter_column('main_song', 'comment_node_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.SongCommentNode']))
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 25, 0, 19, 45, 727384)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
