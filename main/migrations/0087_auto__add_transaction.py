...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_transaction', (
            ...
            ('transaction_id', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('request_id', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 17, 7, 17, 33, 213129)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
