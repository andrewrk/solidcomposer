...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountPlan.title'
        db.add_column('main_accountplan', 'title', self.gf('django.db.models.fields.CharField')(default='Free', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccountPlan.title'
        db.delete_column('main_accountplan', 'title')
