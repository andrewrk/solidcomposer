...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.studio'
        db.add_column('main_song', 'studio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Studio'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Song.studio'
        db.delete_column('main_song', 'studio_id')
