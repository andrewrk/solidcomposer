...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SongCommentNode'
        db.create_table('main_songcommentnode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')()),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('content', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('reply_disabled', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('song', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Song'])),
            ('position', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('main', ['SongCommentNode'])

        # Adding field 'Song.comment_node'
        db.add_column('main_song', 'comment_node', self.gf('django.db.models.fields.related.ForeignKey')(related_name='song_comment_node', null=True, to=orm['main.SongCommentNode']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SongCommentNode'
        db.delete_table('main_songcommentnode')

        # Deleting field 'Song.comment_node'
        db.delete_column('main_song', 'comment_node_id')
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 25, 0, 13, 53, 9909)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
