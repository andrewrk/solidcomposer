...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.assume_uploaded_plugins_owned'
        db.add_column('main_profile', 'assume_uploaded_plugins_owned', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.assume_uploaded_plugins_owned'
        db.delete_column('main_profile', 'assume_uploaded_plugins_owned')
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 17, 23, 22, 23, 231890)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
