...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Appearance.timestamp'
        db.alter_column('chat_appearance', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ChatMessage.timestamp'
        db.alter_column('chat_chatmessage', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'Appearance.timestamp'
        db.alter_column('chat_appearance', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))

        # Changing field 'ChatMessage.timestamp'
        db.alter_column('chat_chatmessage', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))
